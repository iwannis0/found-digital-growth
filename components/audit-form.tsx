...
export function AuditForm() {
  ...
  if (status === "success") return <div className="form-success" role="status"><CheckCircle2 /><p className="eyebrow">Audit request saved</p><h2>Your audit request is in.</h2><p>It is now available to the FOUND. team. We&apos;ll review your website and get back to you with the clearest opportunities we find.</p><button className="text-link" onClick={() => setStatus("idle")}>Submit another website</button></div>;
