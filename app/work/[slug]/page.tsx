...
export default async function ProjectPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className={`case-study case-${project.tone}`}><PageTracker event="project_view" label={project.name} />
    ...
    {project.slug === "aura-dental" && <section className="aura-preview-entry"><div className="site-container"><div><p className="eyebrow">Website concept</p><h2>Explore the AURA website.</h2><p>Open the full responsive mockup to see the design as a website.</p></div><Link className="button button-dark button-large" href="/work/aura-dental/demo">View website mockup <ArrowRight /></Link></div></section>}
    {project.slug === "ora-jewellery" && <section className="aura-preview-entry"><div className="site-container"><div><p className="eyebrow">Website concept</p><h2>Explore the ORA website.</h2><p>The full jewellery website mockup is coming soon.</p></div><span className="button button-dark button-large ora-preview-placeholder" aria-label="View website mockup, coming soon">View website mockup <ArrowRight /></span></div></section>}
