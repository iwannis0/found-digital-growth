...
export const metadata: Metadata = { title: "About", description: "FOUND. is a Cyprus local digital growth company focused on websites, visibility and measurable customer actions." };
...
export default function AboutPage() { return <main>
  ...
  <section className="belief-section section-pad"><div className="site-container belief-grid"><p className="eyebrow">Our point of view</p><blockquote>A website is only valuable when the right people can find it, trust it and know what to do next.</blockquote><div><p>That is why our work connects design with local visibility, analytics, maintenance and ongoing improvement.</p><p>We use plain language, document the scope and recommend the level of complexity the business actually needs.</p></div></div></section>
