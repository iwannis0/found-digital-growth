...
export default function FreeAuditPage() { return <main className="audit-page">
  ...
  <section className="audit-form-section"><div className="site-container audit-form-grid"><div><p className="eyebrow">Your details</p><h2>Give us enough context to make the review useful.</h2><p>Fields marked with * are required. Your information is used to review the request and contact you about it.</p></div><div className="form-panel"><AuditForm /></div></div></section>
  </main>; }
